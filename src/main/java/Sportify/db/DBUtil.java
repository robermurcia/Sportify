...
import Sportify.exception.DBConnectionException;
import Sportify.exception.SQLStatmentException;
...
@Component
public class DBUtil {
    private static final String URL_CONNECTION = "jdbc:mysql://localhost:3306/sportify";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "rmurcia";
